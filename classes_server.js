const resp = require('./response.js');   //5 times
...
exports.classes = function (queryObj, res) {
    ...
    switch (classLevel) {
        case "all": {
            resp.sendResponse(res, 200, 'application/json', by + iy + ay + gy + cy + kty + m);
            break;
        };
        case "beginner": {
            resp.sendResponse(res, 200, 'application/json', by + gy + cy + kty + m);
            break;
        };
        case "intermediate": {
            resp.sendResponse(res, 200, 'application/json', iy);
            break;
        };
        case "advanced": {
            resp.sendResponse(res, 200, 'application/json', ay);
            break;
        };
        default: {
            resp.sendResponse(res, 200, 'application/json', by + iy + ay + gy + cy + kty + m);
